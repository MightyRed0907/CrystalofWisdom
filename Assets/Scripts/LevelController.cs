...
public class LevelController : MonoBehaviour
{
        ...
        foreach (Transform t in transform) {
            ...
            switch (t.tag) {
                ...
                case "RedMummy":
                    ...
                    break;
                case "Stair":
                    crystalPosition = t.localPosition;
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown("up") || Input.GetKeyDown(KeyCode.W)) direction = Vector3.up;
        else if (Input.GetKeyDown("down") || Input.GetKeyDown(KeyCode.S)) direction = Vector3.down;
        else if (Input.GetKeyDown("left") || Input.GetKeyDown(KeyCode.A)) direction = Vector3.left;
        else if (Input.GetKeyDown("right") || Input.GetKeyDown(KeyCode.D)) direction = Vector3.right;
    ...
    IEnumerator Action(Vector3 direction) {
        ...
        if (player.transform.localPosition == crystalPosition) {
    ...
    IEnumerator Lost() {
        ...
        GameObject.Find("Window3").transform.DOLocalMoveY(-80f, 0.5f).SetEase(Ease.Linear);
        GameObject.Find("Pharaoh's words").GetComponent<Text>().text = "Foolish man you do not deserve";
    }
